...
HD_PWD='D:/git/UTCN_CS_2nd_year/CA/practice_lab/lab02/combinational_shifter/combinational_shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shifter_tester.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shifter_tester.tcl -notrace
