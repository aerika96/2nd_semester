...
A1_DATA = ""
A1_PROG = "a1"
VERBOSE = False
VALGRIND = False
...
def perform_a1(data, cmd):
    ...
    if cmd[0] == "variant":
        ...
        if "size_greater" in options:
            results = [x for x in results if os.path.isdir(x) or 
                            (os.path.isfile(x) and os.path.getsize(x) > int(options["size_greater"]))]
        if "size_smaller" in options:
            results = [x for x in results if os.path.isdir(x) or 
                            (os.path.isfile(x) and os.path.getsize(x) < int(options["size_smaller"]))]
